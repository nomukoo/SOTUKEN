...
<div class="col-3">
<button class="btn btn-outline-info rounded-pill" type="submit" style="width:250px" formaction="/defrost_list"> 解凍一覧画面に戻る</button>
    </div>
<div class="col-3">
<button class="btn btn-outline-info rounded-pill" type="submit" style="width:250px" formaction="/dilution_read"> 希釈一覧画面に進む</button>
    </div>
    </div>
  </div>
</div>
