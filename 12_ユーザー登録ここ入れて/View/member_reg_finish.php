...
@endif
    ...
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
      <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        <h1 class="h1">従業員登録完了</h1>
        <div id="smartwizard" class="sw-theme-arrows">
        <ul class="nav nav-tabs step-anchor">
        <li ><a>従業員登録<br><small></small></a></li>
         <li ><a>従業員登録確認<br><small></small></a></li>
         <li class="active"><a>従業員登録完了<br><small></small></a></li>
        </ul>
      </div>
...
<div class="col-3">
<button class="btn btn-outline-info rounded-pill" type="submit" style="width:250px" formaction="/top"> ホームに戻る</button>
    </div>
    </div>
  </div>
</div>
