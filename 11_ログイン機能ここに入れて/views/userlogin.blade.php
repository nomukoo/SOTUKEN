...
<html lang="ja">
    ...
    <div class="form">
  <form action="{{url('/top2')}}" method="post" >
        @csrf
...
<div class="form">
  ...
  <form action="{{url('/newmember')}}" method="POST" >
           	 @csrf    
  ...
  <div class="text-input">
    <label for="password">Password(任意)</label>
      <div class="fieldPassword">
        <input type="password" name="password" id="textPassword1" required />
  ...
  <div class="text-input">
    <label for="password">Password(確認)</label>
      <div class="fieldPassword">
        <input type="password" name="password" id="textPassword2" required />
