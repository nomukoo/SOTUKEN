...
<a class="nav-link" href="hospitalinput">
  ...
  病院登録
    ...
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
      <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        ...
        <li class="active"><a>廃棄登録<br><small></small></a></li>
         <li  ><a>廃棄登録確認<br><small></small></a></li>
         <li><a>廃棄完了<br><small></small></a></li>
        </ul>
      </div>
  ...
  <td scope="row" class="table-white border-dark" style="width:500px">10
...
<div class="col-1">
<button class="btn btn-success rounded-pill" type="submit" style="width:90px" formaction="/disposal_confirm"> <h4>確認</h4></button>
    </div>
    </div>
    </form>
