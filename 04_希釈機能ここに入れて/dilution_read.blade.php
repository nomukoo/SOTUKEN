...
<a class="nav-link" href="hospitalinput">
  ...
  <td scope="row" class="table-white border-dark" >40</td>
    </tr>
    <tr>
  <td scope="row" class="table-white border-dark" >コミナティ筋注2</td>
  <td scope="row" class="table-white border-dark" >FK125678</td>
...
<form class="row g-4 needs-validation" novalidate>
  ...
  <div class="col-md-4">
  <label for="example2" class="form-label">ワクチン種類選択：</label>
  <select class="form-select form-select-lg mb-3" class="form-control" aria-label=".form-select-lg example" style="width:300px">
  
  <option selected　value="1">コミナティ筋注</option>
  
  <option value="2">コミナティ筋注2</option>
</select>
    </div>
    <div class="col-md-4">
    <label for="validationCustom01" class="form-label">希釈数入力</label>
    <input type="text" class="form-control" id=""  style="width:300px" pattern="^[0-9]+$" required>
...
<div class="col-2">
<button class="btn btn-success rounded-pill" type="submit" style="width:90px" formaction="/dilution_confirm"> <h4>確認</h4></button>
    </div>
    </div>
    </form>
