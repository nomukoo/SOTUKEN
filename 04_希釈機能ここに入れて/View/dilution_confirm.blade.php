...
<div class="container-fluid">
  ...
  <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse">
    ...
    <tbody >
    <tr>
      <th scope="col"class="table-dark border-dark">希釈ID</th>
  ...
  @foreach($dilution_list as $dilution_lists)
    <tr>
      <td scope="row" class="table-white border-dark" >{{$dilution_lists->dilution_ID}}</td>
...
<form class="row g-4 needs-validation" action="{{url('/dilution_finish')}}" method="post" novalidate>
<div class="text-center">
