  ...
  <div class="row">
    ...
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
      <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        ...
        <li ><a>患者読み取り<br><small></small></a></li>
         <li ><a>情報確認<br><small></small></a></li>
         <li class="active"><a>受付完了<br><small></small></a></li>
        </ul>
      </div>
...
<div class="d-flex justify-content-center">
  ...
  <button type="button" class="btn btn-outline-info rounded-pill " style="width:250px" >トップページに戻る</button>
  </div>
</div>
    </form>
