...
<div class="container-fluid">
  ...
  <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse">
    ...
    <form action="{{url('/hospitalinputfinish')}}" method="post"  class="row g-4 needs-validation" novalidate>
      @csrf
<div class="m-5">
    </div>
  ...
  <tr>
  <td scope="row" class="table-white border-dark" >{{ Session::get('hospital_ID') }}</td>
  <td scope="row" class="table-white border-dark" >{{ Session::get('hospital_name') }}</td>
  <td scope="row" class="table-white border-dark" >{{ Session::get('hospital_address') }}</td>
  <td scope="row" class="table-white border-dark" >{{ Session::get('hospital_tell') }}</td>
  <td scope="row" class="table-white border-dark" >{{ Session::get('hospital_ido') }}</td>
  <td scope="row" class="table-white border-dark" >{{ Session::get('hospital_keido') }}</td>
