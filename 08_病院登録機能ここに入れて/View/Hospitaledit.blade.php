...
<div class="container-fluid">
  ...
  <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse">
    ...
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
      <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        <h1 class="h1">病院情報編集画面</h1>
        <div id="smartwizard" class="sw-theme-arrows">
        <ul class="nav nav-tabs step-anchor">
         <li class="active"><a>病院情報編集<br><small></small></a></li>
         <li ><a>編集確認<br><small></small></a></li>
         <li><a>編集完了<br><small></small></a></li>
        </ul>
      </div>
    ...
    <form action="{{url('/hospitaleditverifi')}}" method="post"  class="row g-4 needs-validation" novalidate>
  <div class="col-md-4">
    <label for="hospital_ID" class="form-label">ID</label>
    <input type="text" class="form-control"  value="{{Session::get('hospital_ID') }}" required>
  ...
  <div class="col-md-4">
    ...
    <input type="text" class="form-control" id="hospital_name"  value="{{ Session::get('hospital_name') }}" required>
    <div class="invalid-feedback">
      病院名を入力してください
    </div>
    <div class="valid-feedback">
  ...
  <div class="col-md-8">
    <label for="hospital_address" class="form-label">住所</label>
      ...
      <input type="text" class="form-control" id="hospital_address" aria-describedby="inputGroupPrepend" value="{{ Session::get('hospital_address') }}" required>
      <div class="invalid-feedback">
        住所を入力してください
      </div>
      <div class="valid-feedback">
  ...
  <div class="col-md-4">
    ...
    <input type="tel" class="form-control" id="hospital_tell" pattern="\d{2,4}-?\d{2,4}-?\d{3,4}" placeholder="例: ○○○-××××-○○○○" value="{{ Session::get('hospital_tell') }}" required>
    <div class="invalid-feedback">
      電話番号を入力してください
    </div>
    <div class="valid-feedback">
  ...
  <div class="col-md-4">
    ...
    <input type="text" class="form-control" id="hospital_idokeido" pattern="\d{1,4}.\d{1,8},\d{1,4}.\d{1,8}" placeholder="例: 34.380846,132.454321" value="{{ Session::get('hospital_idokeido') }}" required>
    <div class="invalid-feedback">
      緯度・経度を入力してください
    </div>
    <div class="valid-feedback">
