...
<div class="container-fluid">
  ...
  <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse">
    ...
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
      <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        <h1 class="h1">病院情報削除画面</h1>
        <div id="smartwizard" class="sw-theme-arrows">
        <ul class="nav nav-tabs step-anchor">
         <li class="active"><a>削除確認<br><small></small></a></li>
         <li ><a>削除完了<br><small></small></a></li>
        </ul>
      </div>
  ...
  <tr>
  <td scope="row" class="table-white border-dark" >{{  $hospital->hospital_ID }}</td>
  ...
  <td scope="row" class="table-white border-dark" >{{  $hospital->hospital_idokeido  }}</td>
    </tr>
    @endforeach
...
<form action="{{url('/hospitaldelefinish')}}" method="post">
@csrf
...
<div class="col-1">
  ...
  <div class="col-1">
  <button class="btn btn-success rounded-pill" type="submit" style="width:90px"> <h4>削除</h4></button>
