...
<div class="container-fluid">
  ...
  <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse">
    ...
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
      <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        <h1 class="h1">病院情報編集確認画面</h1>
        <div id="smartwizard" class="sw-theme-arrows">
        <ul class="nav nav-tabs step-anchor">
         <li><a>病院情報編集<br><small></small></a></li>
         <li class="active"><a>編集確認<br><small></small></a></li>
  ...
  <td scope="row" class="table-white border-dark" >{{ Session::get('hospital_idokeido') }}</td>
...
<form action="{{url('/hospitaleditfinish')}}" method="post">
@csrf
<div class="text-center">
