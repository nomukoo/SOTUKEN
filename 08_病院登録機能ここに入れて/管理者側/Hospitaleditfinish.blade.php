...
<button class="btn btn-outline-info rounded-pill" type="buttom" style="width:250px" formaction="/hospitallist"> 病院情報一覧に戻る</button>
  </div>
</div>
    </form>
